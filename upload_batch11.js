...
async function uploadBatch11() {
  const saintsData = JSON.parse(fs.readFileSync('batch11_remaining.json', 'utf8'));
  ...
  console.log('Batch 11 upload completed!');
}

uploadBatch11().catch(console.error).finally(() => process.exit(0));