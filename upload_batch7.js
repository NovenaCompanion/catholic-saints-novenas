...
async function uploadBatch7() {
  const saintsData = JSON.parse(fs.readFileSync('batch7_final.json', 'utf8'));
  ...
  console.log('Batch 7 upload completed!');
}

uploadBatch7().catch(console.error).finally(() => process.exit(0));