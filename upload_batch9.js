...
async function uploadBatch9() {
  const saintsData = JSON.parse(fs.readFileSync('batch9_remaining.json', 'utf8'));
  ...
  console.log('Batch 9 upload completed!');
}

uploadBatch9().catch(console.error).finally(() => process.exit(0));