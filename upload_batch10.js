...
async function uploadBatch10() {
  const saintsData = JSON.parse(fs.readFileSync('batch10_remaining.json', 'utf8'));
  ...
  console.log('Batch 10 upload completed!');
}

uploadBatch10().catch(console.error).finally(() => process.exit(0));