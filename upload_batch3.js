...
async function uploadBatch3() {
  const saintsData = JSON.parse(fs.readFileSync('batch3_saints.json', 'utf8'));
  ...
  console.log('Batch 3 upload completed!');
}

uploadBatch3().catch(console.error).finally(() => process.exit(0));