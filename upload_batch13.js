...
async function uploadBatch13() {
  const saintsData = JSON.parse(fs.readFileSync('batch13_final.json', 'utf8'));
  ...
  console.log('Batch 13 final upload completed!');
}

uploadBatch13().catch(console.error).finally(() => process.exit(0));