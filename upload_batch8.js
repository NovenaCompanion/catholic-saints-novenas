...
async function uploadBatch8() {
  const saintsData = JSON.parse(fs.readFileSync('batch8_remaining.json', 'utf8'));
  ...
  console.log('Batch 8 upload completed!');
}

uploadBatch8().catch(console.error).finally(() => process.exit(0));