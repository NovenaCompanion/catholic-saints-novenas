...
async function uploadBatch6() {
  const saintsData = JSON.parse(fs.readFileSync('batch6_saints.json', 'utf8'));
  ...
  console.log('Batch 6 upload completed!');
}

uploadBatch6().catch(console.error).finally(() => process.exit(0));