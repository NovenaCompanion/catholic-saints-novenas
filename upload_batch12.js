...
async function uploadBatch12() {
  const saintsData = JSON.parse(fs.readFileSync('batch12_remaining.json', 'utf8'));
  ...
  console.log('Batch 12 upload completed!');
}

uploadBatch12().catch(console.error).finally(() => process.exit(0));