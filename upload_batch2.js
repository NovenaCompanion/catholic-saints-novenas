...
async function uploadBatch2() {
  const saintsData = JSON.parse(fs.readFileSync('batch2_saints.json', 'utf8'));
  ...
  console.log('Batch 2 upload completed!');
}

uploadBatch2().catch(console.error).finally(() => process.exit(0));