...
async function uploadBatch5() {
  const saintsData = JSON.parse(fs.readFileSync('batch5_saints.json', 'utf8'));
  ...
  console.log('Batch 5 upload completed!');
}

uploadBatch5().catch(console.error).finally(() => process.exit(0));