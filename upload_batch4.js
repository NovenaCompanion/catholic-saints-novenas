...
async function uploadBatch4() {
  const saintsData = JSON.parse(fs.readFileSync('batch4_saints.json', 'utf8'));
  ...
  console.log('Batch 4 upload completed!');
}

uploadBatch4().catch(console.error).finally(() => process.exit(0));